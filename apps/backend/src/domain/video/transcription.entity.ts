...
export class Transcription {
  ...
  static restore(props: { videoId: string; language: string; segments: TranscriptSegment[] }): Transcription { return new Transcription(props.videoId, props.language, props.segments); }
}
